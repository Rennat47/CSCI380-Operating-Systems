...
public class HeatPlate implements Runnable
{
     ...
     */
    public HeatPlate(int w, int h, double leftHeat, double topHeat, double rightHeat, double bottomHeat, int num_threads)
    {
        //Link globals
...
//        totalError = localErrorSum;
    ...
    public void run()
    {
        ...
        do
        {
            double localError = calculateRange(range[0], range[2], range[1], range[3]);
